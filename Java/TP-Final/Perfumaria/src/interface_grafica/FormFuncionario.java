...
public class FormFuncionario extends JFrame {
	...
	public boolean validarCampos() {
		...
		if (tfCPF.getText() != "") {
			...
			if (strCPF.length() != 11) {
				...
				JOptionPane.showMessageDialog(null,
						"Digite um valor válido no campo CPF",
						"Erro de validação", JOptionPane.ERROR_MESSAGE);
				livre = 1;
			}
		}// fim cpf validação
		...
		if ((tfTelefone.getText().equals(vazio))
			...
			JOptionPane.showMessageDialog(null,
					"O telefone deve ser inserido!", "Erro de validação",
		...
		if (tfTelefone.getText() != "") {
			...
			if (strTel.length() >= 15) {
				...
				JOptionPane.showMessageDialog(null,
						"Digite um valor válido no campo telefone",
						"Erro de validação", JOptionPane.ERROR_MESSAGE);
				livre = 1;
			}
		...
		// início endereço validação
		if ((tfEndereco.getText().equals(vazio))
				|| (tfEndereco.getText().equals(null))) {

			JOptionPane.showMessageDialog(null,
					"O endereco deve ser inserido!", "Erro de validação",
					JOptionPane.ERROR_MESSAGE);

			livre = 1;

		}
		// fim endereço validação
	...
	public static void atualizaTabela() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Não foi possível salvar os dados cadastrados.",
					"Erro de validação", JOptionPane.ERROR_MESSAGE);
			e.printStackTrace();
		}
	}
